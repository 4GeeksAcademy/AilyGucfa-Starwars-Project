        ...
        <>
            <div className="container-fluid">
                <div className="row ">
                    <div className="col-4">
                    <img
                        src={`https://starwars-visualguide.com/assets/img/planets/${parsedPlanetId}.jpg`} 
                    ...
                    <div className="col-8">
                        <h5>{store.planets[ planetId ]?.name}</h5>
            ...
            <div className="footer-planets">
                <h5 className="footer-captions">Population: <p>{store.planets[planetId]?.population}</p></h5>
                <h5 className="footer-captions">Climate: <p>{store.planets[planetId]?.climate}</p></h5>
                <h5 className="footer-captions">Diameter: <p>{store.planets[planetId]?.diameter}</p></h5>
                <h5 className="footer-captions">Gravity: <p>{store.planets[planetId]?.gravity}</p></h5>
                <h5 className="footer-captions">Terrain: <p>{store.planets[planetId]?.terrain}</p></h5>
