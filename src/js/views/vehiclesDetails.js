    ...
    return (
        <>
            ...
            <div className="footer-vehicles">
                <h5 className="footer-captions">Model</h5>
                <h5 className="footer-captions">Manufacturer</h5>
                <h5 className="footer-captions">Created</h5>
                <h5 className="footer-captions">Vehicle_class</h5>
                <h5 className="footer-captions">Passengers</h5>
