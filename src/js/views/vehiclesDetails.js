...
const VehiclesDetails = () => {
    ...
    return (
        <>
            <div className="container-fluid">
                <div className="row ">
                    <div className="col-4">
                        <img src={
                                `https://starwars-visualguide.com/assets/img/vehicles/${parsedVehicleId}.jpg`
                            }
        ...
        <div className="footer-vehicles">
            <h5 className="footer-captions">Model:
                <p>{
                    store.vehicles[vehicleId] ?. model
                }</p>
            </h5>
            <h5 className="footer-captions">Manufacturer:
                <p>{
                    store.vehicles[vehicleId] ?. manufacturer
                }</p>
            </h5>
            <h5 className="footer-captions">Created:
                <p>{
                    store.vehicles[vehicleId] ?. created
                }</p>
            </h5>
            <h5 className="footer-captions">Vehicle_class:
                <p>{
                    store.vehicles[vehicleId] ?. vehicle_class
                }</p>
            </h5>
            <h5 className="footer-captions">Passengers:
                <p>{
                    store.vehicles[vehicleId] ?. passengers
                }</p>
            </h5>
