        ...
        <>
            <div className="container-fluid">
                <div className="row ">
                    <div className="col-4">
                        <img src={
                                `https://starwars-visualguide.com/assets/img/characters/${parsedCharacterId}.jpg`
                            }
        ...
        <div className="footer-character">
            <h5 className="footer-captions">Gender:
                <p className="individualItemInfo"> {
                    store.people[characterId] ?. gender
                } </p>
            </h5>
            <h5 className="footer-captions">Height:
                <p className="individualItemInfo"> {
                    store.people[characterId] ?. height
                } </p>
            </h5>
            <h5 className="footer-captions">Skin_color:
                <p className="individualItemInfo"> {
                    store.people[characterId] ?. skin_color
                } </p>
            </h5>
            <h5 className="footer-captions">Eye_color:
                <p className="individualItemInfo">{
                    store.people[characterId] ?. eye_color
                } </p>
            </h5>
        </div>
    </>
